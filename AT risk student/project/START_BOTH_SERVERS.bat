...
echo.
start "Backend Server" cmd /k "cd /d %~dp0backend && set API_HOST=127.0.0.1 && set API_PORT=8006 && (if exist venv\Scripts\python.exe (venv\Scripts\python.exe run.py) else (python run.py))"
